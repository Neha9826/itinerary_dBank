...
// JOIN QUERY: Get the Custom Content + The Master's Branding Images
...
// Decode the CUSTOM JSON (The one with employee edits)
...
<style>
    /* EXACT SAME STYLES AS YOUR WORKING MASTER DOWNLOADER */
    ...
    @page Section1 { size: 8.5in 11.0in; margin: 0.5in 0.8in 0.5in 0.8in; }
    div.Section1 { page: Section1; }

    @page Section2 { 
        size: 8.5in 11.0in; 
        margin: 1.0in 0.8in 1.0in 0.8in;
        mso-header-margin: 0.5in; mso-footer-margin: 0.5in;
